...
export function ToolBar() {
  const { state, selectRegion, performAction, setCameraMode, setMovementMode, toggleAnatomy, toggleTracking } = useSimulation();
